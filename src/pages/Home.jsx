...
const Home = (props) => {
 ...
 useEffect(() => {
  ...
  return (
    <div className='h-screen w-screen bg-cover bg-center ' style={{
          backgroundImage:
        ...
        <a className='hover:opacity-70 transition-opacity cursor-pointer' href="https://github.com/piyushhdotai">
        <FaGithub size={25}/>
        </a>
        

        <a className='hover:opacity-70 transition-opacity cursor-pointer' href="https://www.linkedin.com/in/piyushhdotai/?skipRedirect=true">
        <FaLinkedin size={25} />
        </a>

        <a className='hover:opacity-70 transition-opacity cursor-pointer' href="https://leetcode.com/u/piyushh_7274/">
        <SiLeetcode size={25} />
        </a>
        ...
        <section id="about" className="h-screen bg-slate-950 ">
          <div className='flex '>
